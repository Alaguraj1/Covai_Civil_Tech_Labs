...
const DefaultLayout = ({ children }: PropsWithChildren) => {
    ...
    const pagesWithoutLogin = ['viewinvoicereport', 'print', 'print1', 'r', 'c'];
        ...
        <App>
            ...
            <div className="relative">
                ...
                <div className="fixed bottom-6 z-50 ltr:right-6 rtl:left-6">
                    {showTopButton && (
                        <button type="button" className="btn btn-outline-brown bg-brown animate-pulse rounded-full bg-[#fafafa] p-2 dark:bg-[#060818]" onClick={goToTop}>
